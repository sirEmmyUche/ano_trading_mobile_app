...
const baseUrl:string = 'https://8b66-105-112-214-213.ngrok-free.app'  
...
export const getPastSignals = async(page:number)=>{
    try{
        const res = await fetch(`${baseUrl}/api/past/signals?page=${page}`,{
            credentials: 'include',
    })
        const data = await res.json();
        return data;
